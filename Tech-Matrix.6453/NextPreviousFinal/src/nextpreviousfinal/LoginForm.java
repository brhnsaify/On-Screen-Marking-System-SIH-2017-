...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_uid.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        txt_pwd.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        if(txt_uid.getText().equals("neeraj") && txt_pwd.getText().equals("vyas"))  
        {
            try {
                new OnScreenMarkingSystem();
            } catch (IOException ex) {
                Logger.getLogger(LoginForm.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        else if(txt_uid.getText().equals("ankit") && txt_pwd.getText().equals("deo"))
        {
            new HeadEvaluator();
        }
